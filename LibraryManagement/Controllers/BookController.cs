...
namespace LibraryManagement.Controllers
{
    ...
    public class BookController : ControllerBase
    {
        ...
        // Endpoint tạo sách
        [HttpPost("add_book")]
        public async Task<IActionResult> addHeaderBook(HeaderBookCreationRequest request)
        {
        ...
        public async Task<IActionResult> updateHeaderBook(HeaderBookUpdateRequest request, 
                                                          string idBook, 
                                                          string idTheBook)
        {
